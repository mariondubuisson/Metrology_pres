      ...
      <div>
        ...
        <div className="accordeon">
          <section className="accordeon_section">
            <h2 className="accordeon_section_title">
              Qu'est-ce que la métrologie ?
            </h2>
            <div className="accordeon_section_content">
              <p className="content">
              ...
              <p className="content">
                ...
                comparer l'indication de notre équipement avec celle d'un
                étalon. Elle est réalisée avec maîtrise des incertitudes suivant
                une procédure et fait l'objet d'un constat de vérification.
                <br />
                On en déduit une conformité par rapport à une spécification.
              </p>
              <p className="content">
                <span className="important_thing">Erreur</span> : c'est l'écart
                entre l'indication de notre appareil et celle de l'étalon. On
                peut la corriger par une régression, mais il restera toujours un
                résidu (appelé erreur d'interpolation).
              </p>
              ...
              <section className="timeline_full_container">
                ...
                <div className="view_timeline">
                  <div className="timeline_container timeline_equipment">
                    ...
                    <div className="timeline_item">
                      <h4 className="timeline_title">3. Premier étalonnage</h4>
                      <p className="timeline_content">
                    ...
                    <div className="timeline_item">
                      ...
                      <p className="timeline_content">
                        ...
                        l'équipement ne dérive pas, dans une certaine mesure (à
                        définir)
                      </p>
                    </div>
                    ...
                    <div className="timeline_item">
                      ...
                      <p className="timeline_content">
                        Périodiquement, le capteur est étalonné pour évaluer sa
                        dérive et ajuster les corrections à appliquer
                        <br />
                        La périodicté peut être revue si l'équipement ne dérive
                        pas
                      </p>
                    </div>
                  </div>
          ...
          <section className="accordeon_section">
            <h2 className="accordeon_section_title">Qui est concerné ?</h2>
            <div className="accordeon_section_content">
              <h3 className="section_subtitle">
          ...
          <section className="accordeon_section">
            <h2 className="accordeon_section_title">Comment faire ?</h2>
            <div className="accordeon_section_content">
              <h3 className="section_subtitle">
                  ...
                  <div className="timeline_container timeline_process">
                    <div className="timeline_item">
                      ...
                      <p className="timeline_content">
                        ...
                        <br />
                        Il est nécessaire qu'il soit utilisateur des équipements
                        pour connaître leur fonctionnement et leurs besoins
                        métrologiques.
                      </p>
                    </div>
                    ...
                    <div className="timeline_item">
                      ...
                      <p className="timeline_content">
                        ...
                        utilisés.
                        <br />
                        Récupérer les informations utiles à leur fonctionnement
                        (manuel utilisateur, factures, historique des
                    ...
                    <div className="timeline_item">
                      ...
                      <p className="timeline_content">
                        Au CSTB, l'outil de gestion des équipements est Fiche de
                        Vie, accessible par tous.
                        <br />
                        Enregistrer tous les équipements de mesure dans cette
                        base avec les informations utiles à leur fonctionnement.
                      </p>
                    </div>

                    <div className="timeline_item">
                      <h4 className="timeline_title">4. Raccordement au SI</h4>
                      <p className="timeline_content">
                        Identifier par type d'équipement et par utilisation les
                        besoins en terme de traçabilité au SI.
                        <br />
                    ...
                    <div className="timeline_item">
                      ...
                      <p className="timeline_content">
                        Documenter par des procédures et enregistrements toutes
                        les preuves de traçabilité (raccordement, calibrages,
                        contrôles ...)
                      </p>
                    </div>
                  </div>
              ...
              <p className="content">
                ...
                l'achat ou le raccordement spécifique d'un équipement en vue de
                l'affaire.
              </p>
            </div>
          </section>
          ...
          <section className="accordeon_section">
            <h2 className="accordeon_section_title">Pour quoi faire ?</h2>
            <div className="accordeon_section_content">
              <p className="content">
                Prendre en considération tous les aspects théoriques et
                pratiques ainsi que leurs limites lors d'une mesure permet d'en
              ...
              <p className="content">
                ...
                résultats, on optimise les efforts à fournir et assure une
          ...
          <section className="accordeon_section">
            <h2 className="accordeon_section_title">Ressources</h2>
            <div className="accordeon_section_content">
              <a
